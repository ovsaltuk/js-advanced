class ProductsList {
    ...
    listTotalPrice(productList = this.products){
        let total = 0;
...
class Cart {
    constructor(productArr, container = ".cart"){

    }
    // Создает элемент корзины, добавдяет в массив товаров
    _createItem(){}
    ...
    //отрисовывет корзину на странице
    _render(){}

    //Считает сумму товаров и кол-во
    _calcTotal(){}
